...
<hr>
<h2 stlye="color:yellow">This lab is currently under construction, currently working on getting the Wazuh dashboard installed and connected to Suricata for the IDS</h2>
